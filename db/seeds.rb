...
question1 = Question.create({ default: response1["text"], text: "What does it mean for a method to return a value?"})
question2 = Question.create({ default: response2["text"], text: "What is the difference between a procedure, a function, and a method?" })
question3 = Question.create({ default: response3["text"], text: "What's the difference between a hash and an array?" })
question4 = Question.create({ default: response4["text"], text: "What's the difference between a hash and an object?" })
question5 = Question.create({ default: response5["text"], text: "When should you use map? Select? Reduce? Find?" })
question6 = Question.create({ default: response6["text"], text: "What's the difference between a class and an instance of a class?" })
question7 = Question.create({ default: response7["text"], text: "What's the difference between an instance method and a class method?" })
question8 = Question.create({ default: response8["text"], text: "What is a gem? Gemfile? Gemfile.lock?" })
question9 = Question.create({ default: response9["text"], text: "What is a one to many relationship? Many to many?" })
question10 = Question.create({ default: response10["text"], text: "How does a database relate 2 tables?" })
question11 = Question.create({ default: response11["text"], text: "What does single source of truth mean in terms of related objects?" })
question12 = Question.create({ default: response12["text"], text: "What is the purpose of the environment.rb file?" })
question13 = Question.create({ default: response13["text"], text: "What does an ORM do?" })
question14 = Question.create({ default: response14["text"], text: "What is an API?" })
question15 = Question.create({ default: response15["text"], text: "What is semantic HTML?" })
question16 = Question.create({ default: response16["text"], text: "What is the DOM?" })
question17 = Question.create({ default: response17["text"], text: "Describe the HTTP Request/Response cycle" })
question18 = Question.create({ default: response18["text"], text: "What's the difference between the web and the internet?" })
question19 = Question.create({ default: response19["text"], text: "What is validation, where can it occur, and what purpose does it serve?" })
question20 = Question.create({ default: response20["text"], text: "What is an event?" })
question21 = Question.create({ default: response21["text"], text: "What is event bubbling?" })
question22 = Question.create({ default: response22["text"], text: "What is referential transparency?" })
question23 = Question.create({ default: response23["text"], text: "What are the 4 pillars of OOP?" })
question24 = Question.create({ default: response24["text"], text: "What are some tenets of functional programming?" })
question25 = Question.create({ default: response25["text"], text: "What's the difference between authentication and authorization?" })
question26 = Question.create({ default: response26["text"], text: "How do you avoid storing plain-text passwords?" })
question27 = Question.create({ default: response27["text"], text: "What is serialization?" })
question28 = Question.create({ default: response28["text"], text: "Describe the MVC architecture pattern" })
question29 = Question.create({ default: response29["text"], text: "What is Big O?" })
question30 = Question.create({ default: response30["text"], text: "What is a closure?" })
question31 = Question.create({ default: response31["text"], text: "What is CORS?" })
question32 = Question.create({ default: response32["text"], text: "What's the semantic difference between PUT and PATCH?" })
question33 = Question.create({ default: response33["text"], text: "What is DRY?" })
